          ...
          >
            <div className="relative h-52 overflow-hidden bg-[#0b0e13]">
              ...
              <div className="absolute left-5 top-5 flex items-center gap-3">
                {item.logo ? (
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/[0.08] text-[#a7ff5a]">
            ...
            <div className="p-7">
              ...
              <div className="mt-8 border-t border-white/[0.07] pt-5 text-sm">
                <p className="font-medium text-white/48">
                  {item.period}
                </p>
